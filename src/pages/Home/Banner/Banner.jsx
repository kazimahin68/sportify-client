...
const Banner = () => {
    return (
        <div>
            <Carousel showArrows={true} centerSlidePercentage={true} >
                <div>
                    <img className="" src={slide1} />
                    <div className="absolute bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] text-white flex items-center z-0 md:px-20 top-0 h-full">
                        <div className='mx-auto w-2/3'>
                            <h2 className="font-bold text-5xl mb-10 text-orange-500">Soccer Training</h2>
                            <p className="">Summer camp soccer training focuses on technical skills, tactical understanding, and game awareness. Fitness exercises improve stamina, while emphasizing sportsmanship and teamwork. Training is engaging and fun, with games and challenges to motivate participants. The goal is to enhance skills and love for the game in a positive environment.</p>
                            <button className='btn btn-outline hover:bg-orange-500 text-white mt-10'>See details about classes</button>
                        </div>
                    </div>
